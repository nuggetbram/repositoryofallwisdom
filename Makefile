...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sat 21. Feb 13:08:34 2015
# Project:  GreenCoinX.pro
# Template: app
# Command: f:\BTCDeps\Qt\4.8.5\bin\qmake.exe USE_UPNP=- USE_QRCODE=1 -o Makefile GreenCoinX.pro
#############################################################################
...
Makefile: GreenCoinX.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
		...
		f:/BTCDeps/Qt/4.8.5/lib/QtXml.prl \
		f:/BTCDeps/Qt/4.8.5/lib/QtGui.prl \
		f:/BTCDeps/Qt/4.8.5/lib/QtCore.prl
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 -o Makefile GreenCoinX.pro
