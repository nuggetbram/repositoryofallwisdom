             ...
             bool& fIsEncrypted,  bool& fAnyUnordered, string& strType, string& strErr)
{
    try {
		...
		else if (strType == "stakeSplitThreshold") //presstab GreenCoinX
		{
            ssValue >> pwallet->nStakeSplitThreshold;
		}
		else if (strType == "multisend") //presstab GreenCoinX
		{
			unsigned int i;
			ssKey >> i;
		...
		else if(strType == "msettings")//presstab GreenCoinX
		{
		...
		else if(strType == "mdisabled")//presstab GreenCoinX
		{
